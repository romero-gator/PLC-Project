                        ...
                        new Ast.Source(
                                ...
                                Arrays.asList(
                                        init(new Ast.Method("f", Arrays.asList(), Arrays.asList(), Optional.of("Integer"), Arrays.asList(
                                            new Ast.Stmt.Return(init(new Ast.Expr.Literal("x"), ast -> ast.setType(Environment.Type.INTEGER)))
                                        ...
                                        init(new Ast.Method("g", Arrays.asList(), Arrays.asList(), Optional.of("Decimal"), Arrays.asList(
                                            new Ast.Stmt.Return(init(new Ast.Expr.Literal("y"), ast -> ast.setType(Environment.Type.DECIMAL)))
